...
HD_PWD='/home/users/thierry.besson/ql_designs/VexRiscv/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VexRiscv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VexRiscv.tcl
