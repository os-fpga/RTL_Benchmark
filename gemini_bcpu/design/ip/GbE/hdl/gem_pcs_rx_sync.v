...
//------------------------------------------------------------------------------
//
//   Filename:           gem_pcs_rx_sync.v
//   Module Name:        gem_pcs_rx_sync
//
...
//                      clock domains to the rx_clk domain.
//                      Necessary for protection against metastability.
//
//------------------------------------------------------------------------------


module gem_pcs_rx_sync (
   ...
   output [7:0]   mr_adv_ability_s; // Base page to tx.
   output         mr_adv_ability_par_s;
   output [15:0]  mr_np_tx_s;       // Next page.
   output [1:0]   mr_np_tx_par_s;
   ...
   cdnsdru_datasync_v1 #(
      .CDNSDRU_DATASYNC_DIN_W(32'd9)
   ) i_cdnsdru_datasync_v1_mr_adv_ability (
      .clk(rx_clk),
      .reset_n(n_reset),
      .din({mr_adv_ability_par,mr_adv_ability}),
      .dout({mr_adv_ability_par_s,mr_adv_ability_s}));

   cdnsdru_datasync_v1 #(
      .CDNSDRU_DATASYNC_DIN_W(32'd18)
   ) i_cdnsdru_datasync_v1_mr_np_tx (
      .clk(rx_clk),
      .reset_n(n_reset),
      .din({mr_np_tx_par,mr_np_tx}),
      .dout({mr_np_tx_par_s,mr_np_tx_s}));
