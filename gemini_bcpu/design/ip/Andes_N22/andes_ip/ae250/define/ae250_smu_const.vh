`ifdef AE250_SMU_CONST_VH
`else
`define AE250_SMU_CONST_VH

`ifdef AE250_ADDR_WIDTH_24
`define AE250_SMU_RESET_VECTOR_DEFAULT	32'h0080_0000
`else
...
`ifdef NDS_BOARD_CF1
	`define AE250_SMU_CF1_PINMUX_CTRL0_DEFAULT	32'b0
	`define AE250_SMU_CF1_PINMUX_CTRL1_DEFAULT	32'b0
`endif
