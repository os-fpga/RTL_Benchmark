...
`define ATCSPI200_PRODUCT_ID		32'h0200204a
...
`ifdef ATCSPI200_TXFIFO_DEPTH_128W
	`define ATCSPI200_TXFPTR_BITS	8
	`define ATCSPI200_TXFIFO_DEPTH_INF	4'h6
`elsif ATCSPI200_TXFIFO_DEPTH_64W
	`define ATCSPI200_TXFPTR_BITS	7
	`define ATCSPI200_TXFIFO_DEPTH_INF	4'h5
`elsif ATCSPI200_TXFIFO_DEPTH_32W
	`define ATCSPI200_TXFPTR_BITS	6
	`define ATCSPI200_TXFIFO_DEPTH_INF	4'h4
`elsif ATCSPI200_TXFIFO_DEPTH_16W
	`define ATCSPI200_TXFPTR_BITS	5
	`define ATCSPI200_TXFIFO_DEPTH_INF	4'h3
`elsif ATCSPI200_TXFIFO_DEPTH_8W
	`define ATCSPI200_TXFPTR_BITS	4
	`define ATCSPI200_TXFIFO_DEPTH_INF	4'h2
`elsif ATCSPI200_TXFIFO_DEPTH_4W
	`define ATCSPI200_TXFPTR_BITS	3
	`define ATCSPI200_TXFIFO_DEPTH_INF	4'h1
`else
	`define ATCSPI200_TXFPTR_BITS	2
	`define ATCSPI200_TXFIFO_DEPTH_INF	4'h0
`endif

`define ATCSPI200_TXFIFO_DEPTH		(1 << (`ATCSPI200_TXFPTR_BITS - 1))

`ifdef ATCSPI200_RXFIFO_DEPTH_128W
	`define ATCSPI200_RXFPTR_BITS	8
	`define ATCSPI200_RXFIFO_DEPTH_INF	4'h6
`elsif ATCSPI200_RXFIFO_DEPTH_64W
	`define ATCSPI200_RXFPTR_BITS	7
	`define ATCSPI200_RXFIFO_DEPTH_INF	4'h5
`elsif ATCSPI200_RXFIFO_DEPTH_32W
	`define ATCSPI200_RXFPTR_BITS	6
	`define ATCSPI200_RXFIFO_DEPTH_INF	4'h4
`elsif ATCSPI200_RXFIFO_DEPTH_16W
	`define ATCSPI200_RXFPTR_BITS	5
	`define ATCSPI200_RXFIFO_DEPTH_INF	4'h3
`elsif ATCSPI200_RXFIFO_DEPTH_8W
	`define ATCSPI200_RXFPTR_BITS	4
	`define ATCSPI200_RXFIFO_DEPTH_INF	4'h2
`elsif ATCSPI200_RXFIFO_DEPTH_4W
	`define ATCSPI200_RXFPTR_BITS	3
	`define ATCSPI200_RXFIFO_DEPTH_INF	4'h1
`else
	`define ATCSPI200_RXFPTR_BITS	2
	`define ATCSPI200_RXFIFO_DEPTH_INF	4'h0
`endif
