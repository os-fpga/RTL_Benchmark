...
module cdnsdru_datasync_v1 # (
  ...
  parameter CDNSDRU_DATASYNC_SYNC_RESET           = 1'b0,
  parameter CDNSDRU_DATASYNC_NUM_FLOPS            = 32'd2,
  parameter CDNSDRU_DATASYNC_DIN_W                = 32'd1,
  parameter CDNSDRU_DATASYNC_ENABLE_RANDOMIZATION = 1'b1,
  parameter CDNSDRU_DATASYNC_META_WINDOW          = 32'd3,
  parameter CDNSDRU_DATASYNC_REALISTIC_MODE       = 1'b0
