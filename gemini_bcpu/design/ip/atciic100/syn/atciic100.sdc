...
set_input_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports scl_i]
set_input_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports sda_i]
set_input_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports dma_ack]


# Set Output Delays
set_output_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports prdata*]
set_output_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports i2c_int]
set_output_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports scl_o]
set_output_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports sda_o]
set_output_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports dma_req]
