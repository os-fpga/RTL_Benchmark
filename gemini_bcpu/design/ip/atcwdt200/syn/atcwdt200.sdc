...
set_input_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports wdt_pause]

# Set Output Delays
set_output_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports prdata*]
set_output_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports wdt_rst]
set_output_delay -max [expr $pclk_period * 0.7] -clock PCLK [get_ports wdt_int]
