...
module dynamo_sram_rcb #(
  parameter BUFF_NUM   = `CFG_DC_ROUTE_NUM,
  parameter ADDR_WIDTH = `CFG_RCB_ADDR_WIDTH,
  parameter DATA_WIDTH = `CFG_RCB_BUF_WIDTH,
  ...
  localparam  SRAM_NUM  = DATA_WIDTH / 64;
  wire        vdd_wire  ;
  wire        vss_wire  ;

  genvar i;
  generate
    for (i=0; i<BUFF_NUM; i=i+1) begin : READ_BUFFER
      // dti_2pr_tm40ulvt_328x64_2ww1x_hc
      dti_2pr_tm16ffcll_576x64_t4bw2x_m_hc
      rcb_buff[SRAM_NUM-1:0](
        .VDD                ( vdd_wire                               ),
        .VSS                ( vss_wire                               ),
        ...
        .T_CE_N_W           ( 1'b1                                   ),
        .BWE_N              ( 64'h0                                  ),
        .T_BWE_N            ( 64'hFFFF_FFFF_FFFF_FFFF                )
      );
    end
  endgenerate

endmodule // dynamo_sram_rcb
