...
project = u'Gen1 eFPGA IP'
copyright = u'2022, Rapidsilicon'
author = u'Rapidsilicon'
...
htmlhelp_basename = 'Gen1 eFPGA doc'
...
latex_documents = [
    (master_doc, 'gen1_efpga.tex', u'Gen1 eFPGA Documentation',
     u'Rapidsilicon', 'manual'),
]
...
man_pages = [
    (master_doc, 'gen1_efpga', u'Gen1 eFPGA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gen1_efpga', u'Gen1 eFPGA Documentation',
     author, 'Rapidsilicon', 'Gen1 eFPGA project',
     'Miscellaneous'),
]
