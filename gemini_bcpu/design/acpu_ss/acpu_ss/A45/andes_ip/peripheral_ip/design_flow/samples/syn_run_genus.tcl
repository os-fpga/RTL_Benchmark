...
set standard_cell_lib [glob -nocomplain -types f -directory $tech_lib_path ${tech_lib}.lib] 
set memory_lib_list [glob -nocomplain -types f -directory $memory_lib_path *_${mem_cond}.lib]
set lib_list "$standard_cell_lib $memory_lib_list"
...
read_hdl -sv -define $syn_define config.inc $hdl_file_list
...
if {[info exists load_gck_cell]} {
	...
	if {[gck_autogen "gck_autogen.v"]} {
		...
		read_hdl -sv -define $syn_define "gck_autogen.v"
	} else {
