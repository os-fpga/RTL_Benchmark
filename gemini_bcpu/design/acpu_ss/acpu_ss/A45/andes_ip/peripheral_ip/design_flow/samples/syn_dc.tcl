...
###########################################################
# Reference synthesis script for Synopsys Design Compiler #
###########################################################
...
source "$script_path/syn_setup_dc.tcl"
...
# Generic synthesis flow for Synopsys Design Compiler
source "$script_path/syn_run_dc.tcl"
...
file copy -force "$output_path/$design_name.ddc" "$ip_database/$design_name.ddc"
