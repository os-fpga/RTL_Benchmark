...
if {$dsp_support} {
	#borrow time from II-stage
	#set_attribute clock_network_late_latency  -100  [find /designs -pin *a45_core/kv_core/kv_ipipe/gen_dsp_pipe_ctrl.u_kv_dsp_pipe_ctrl/ex_dsp_*_ctrl_reg*/CP*]
}
