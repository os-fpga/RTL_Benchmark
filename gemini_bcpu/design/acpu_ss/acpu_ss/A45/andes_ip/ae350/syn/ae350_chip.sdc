...
set platform			ae350
set cpu_subsys			${platform}_cpu_subsystem
set apb_subsys			${platform}_apb_subsystem
...
# The SPI clock is exactly osch in the current ${platform}_chip clock tree implementation for ASIC.
set spi_clk_period		$env(osch_clk_period)

# The AHB/APB clocks are exactly osch in the current ${platform}_chip clock tree implementation for ASIC.
...
set jtag_twowire_support        [expr [sizeof_collection [get_ports -quiet X_tdi                        ]] == 0]
...
set spi1_ahbbus_support         [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi1/hclk                  ]] != 0]
set spi1_apbbus_support         [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi1/pclk                  ]] != 0]
set spi1_eilmbus_support        [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi1/eilm_clk              ]] != 0]
set spi1_slave_support          [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi1/spi_default_as_slave  ]] != 0]
set spi1_quadspi_support        [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi1/spi_wp_n_oe           ]] != 0]
set spi2_ahbbus_support         [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi2/hclk                  ]] != 0]
set spi2_apbbus_support         [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi2/pclk                  ]] != 0]
set spi2_eilmbus_support        [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi2/eilm_clk              ]] != 0]
set spi2_slave_support          [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi2/spi_default_as_slave  ]] != 0]
set spi2_quadspi_support        [expr [sizeof_collection [get_pins  -quiet $apb_subsys/u_spi2/spi_wp_n_oe           ]] != 0]
set l2c_support			[expr [sizeof_collection [get_pins  -quiet $cpu_subsys/l2c_reset_n	]] != 0]
set slaveport_support		[expr [sizeof_collection [get_pins  -quiet $cpu_subsys/slv_haddr	]] != 0]
...
if {$spi1_support || $spi2_support} {
        set_case_analysis $spi_mode_0	[get_pins $apb_subsys/u_spi*/u_spi_reg/spi_mode*0*]
        set_case_analysis $spi_mode_1	[get_pins $apb_subsys/u_spi*/u_spi_reg/spi_mode*1*]
}
...
create_clock		-name OSCL [get_pins ${platform}_aopd/${platform}_aopd_pin/T_oscl] \
			-period [expr $oscl_clk_period]

# JTAG
create_clock		-name DBG_CLK [get_pins ${platform}_aopd/${platform}_aopd_pin/T_tck] \
			-period [expr $jdtm_clk_period]

# SPI1/2
create_generated_clock [get_pins ${platform}_aopd/sample_${platform}_clkgen/spi_clk]  -name SPI_CLOCK  -divide_by 1 -source [get_pins ${platform}_pin/T_osch]

if {$spi1_slave_support || $spi2_slave_support} {
	create_generated_clock [get_pins ${platform}_aopd/sample_${platform}_clkgen/spi_clk] -name CDC_SPI_CLOCK -divide_by 1 -source [get_pins ${platform}_pin/T_osch] -master [get_clocks SPI_CLOCK] -add
}

if {$spi1_support} {
	create_generated_clock [get_pins $apb_subsys/u_spi1/u_spi_spiif/master_sclk_r_reg/Q] -name SPI1_CLOCK_DIV -divide_by 2 -source [get_pins ${platform}_aopd/sample_${platform}_clkgen/spi_clk] -master [get_clocks SPI_CLOCK] -add
        ...
        if {$spi_mode_0 == $spi_mode_1} {
                create_generated_clock [get_ports X_spi1_clk] -name SPI1_CLK_OUT_ORG -divide_by 1 -source [get_pins ${platform}_aopd/sample_${platform}_clkgen/spi_clk]        -master [get_clocks SPI_CLOCK     ] -add -invert
        } else {
                create_generated_clock [get_ports X_spi1_clk] -name SPI1_CLK_OUT_ORG -divide_by 1 -source [get_pins ${platform}_aopd/sample_${platform}_clkgen/spi_clk]        -master [get_clocks SPI_CLOCK     ] -add
        }
        if {$spi_mode_1} {
	        create_generated_clock [get_ports X_spi1_clk] -name SPI1_CLK_OUT_DIV -divide_by 1 -source [get_pins $apb_subsys/u_spi1/u_spi_spiif/master_sclk_r_reg/Q] -master [get_clocks SPI1_CLOCK_DIV] -add -invert
        } else {
                create_generated_clock [get_ports X_spi1_clk] -name SPI1_CLK_OUT_DIV -divide_by 1 -source [get_pins $apb_subsys/u_spi1/u_spi_spiif/master_sclk_r_reg/Q] -master [get_clocks SPI1_CLOCK_DIV] -add
        }
...
if {$spi2_support} {
	create_generated_clock [get_pins $apb_subsys/u_spi2/u_spi_spiif/master_sclk_r_reg/Q] -name SPI2_CLOCK_DIV -divide_by 2 -source [get_pins ${platform}_aopd/sample_${platform}_clkgen/spi_clk] -master [get_clocks SPI_CLOCK] -add

        # Create the SPI output clock seen by the remote side (slave).
        # The CLK_OUT version of clock lags behind the SPI*_CLOCK version
        # by ($spi_m_sclk_delay/2).
        if {$spi_mode_0 == $spi_mode_1} {
                create_generated_clock [get_ports X_spi2_clk] -name SPI2_CLK_OUT_ORG -divide_by 1 -source [get_pins ${platform}_aopd/sample_${platform}_clkgen/spi_clk]        -master [get_clocks SPI_CLOCK     ] -add -invert
        } else { 
                create_generated_clock [get_ports X_spi2_clk] -name SPI2_CLK_OUT_ORG -divide_by 1 -source [get_pins ${platform}_aopd/sample_${platform}_clkgen/spi_clk]        -master [get_clocks SPI_CLOCK     ] -add
        }
        if {$spi_mode_1} {
	        create_generated_clock [get_ports X_spi2_clk] -name SPI2_CLK_OUT_DIV -divide_by 1 -source [get_pins $apb_subsys/u_spi2/u_spi_spiif/master_sclk_r_reg/Q] -master [get_clocks SPI2_CLOCK_DIV] -add -invert
        } else {
                create_generated_clock [get_ports X_spi2_clk] -name SPI2_CLK_OUT_DIV -divide_by 1 -source [get_pins $apb_subsys/u_spi2/u_spi_spiif/master_sclk_r_reg/Q] -master [get_clocks SPI2_CLOCK_DIV] -add
        }
...
if {$pre_cts} {
	set_ideal_network [get_driver_pin ${platform}_pin/T_osch]
        set_ideal_network [get_driver_pin ${platform}_aopd/${platform}_aopd_pin/T_oscl]
	if {$jdtm_support} {
                set_ideal_network [get_driver_pin ${platform}_aopd/${platform}_aopd_pin/T_tck]
        }
        # Net ${platform}_aopd/sample_${platform}_clkgen/spi_clk may be gone if this SDC is applied to the netlist so use u_spi1/spi_clk.
        set_ideal_network [get_driver_pin $apb_subsys/u_spi1/spi_clock]

        if {$spi1_support} {
                set_ideal_network [get_pins $apb_subsys/u_spi1/u_spi_spiif/master_sclk_r_reg/Q]
                set_ideal_network [get_ports X_spi1_clk]
	}
        if {$spi2_support} {
                set_ideal_network [get_pins $apb_subsys/u_spi2/u_spi_spiif/master_sclk_r_reg/Q]
...
# JTAG
if {$jdtm_support} {
	if {$jtag_twowire_support} {
	        # X_tms is an inout port for the JTAG TWOWIRE support
	        set_input_delay  -clock [get_clocks DBG_CLK] [expr $jdtm_clk_period * 1/3] [get_ports [list X_tms]]
	        set_output_delay -clock [get_clocks DBG_CLK] [expr $jdtm_clk_period * 1/3] [get_ports X_tms]
	} else {
...
if {$spi1_support && $spi1_slave_support} {
        set_false_path -from [get_clocks SPI1_M_SCLK_*] -to [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_clk_in_syn/a_signal_sync*0*]
        set_false_path -from [get_clocks SPI1_M_SCLK_*] -through [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_*_slv_r_*]

        set_false_path -hold -to [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_clk_in_syn/a_signal_sync*0*]
}
if {$spi2_support && $spi2_slave_support} {
        set_false_path -from [get_clocks SPI2_M_SCLK_*] -to [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_clk_in_syn/a_signal_sync*0*]
        set_false_path -from [get_clocks SPI2_M_SCLK_*] -through [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_*_slv_r_*]

        set_false_path -hold -to [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_clk_in_syn/a_signal_sync*0*]
}

# Relationship for SCLK -> SPI_CLOCK -> SCLK in slave mode:
if {$spi1_slave_support} {
        set_false_path -hold -to [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_out_slv_r*]
        set_false_path -hold -to [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_oe_slv_r* ]
...
if {$spi2_slave_support} {
        set_false_path -hold -to [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_out_slv_r*]
        set_false_path -hold -to [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_oe_slv_r* ]
...
if {$spi1_support} {
        set_multicycle_path 2 -setup -from [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_in_r*] -to [get_cells $apb_subsys/u_spi1/u_spi_ctrl/rx_shift_reg_r*] -end
        set_multicycle_path 1 -hold  -from [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_in_r*] -to [get_cells $apb_subsys/u_spi1/u_spi_ctrl/rx_shift_reg_r*] -end
        
	set_false_path -from [get_clocks SPI1_CLK_OUT_DIV] -through [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_in_r_reg*] -to [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_in_d1_r_reg*]
        set_false_path -from [get_clocks SPI1_M_SCLK_DIV] -through [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_in_r_reg*] -to [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_in_d1_r_reg*]

	if {$spi1_slave_support} {
                set_false_path -hold -from [get_clocks SPI1_S_SCLK] -through [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_in_r_reg*] -to [get_cells $apb_subsys/u_spi1/u_spi_ctrl/rx_shift_reg*]
                set_false_path       -from [get_clocks SPI1_S_SCLK] -through [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_in_r_reg*] -to [get_cells $apb_subsys/u_spi1/u_spi_spiif/spi_in_d1_r_reg*]
        }
	...
	# exact setting like:
        #   set_false_path -to_by_clock [get_clocks SPI1_CLK_OUT_*] -to [get_pins $apb_subsys/u_spi1/u_spi_spiif/spi_in_r_reg_*_/D]
...
if {$spi2_support} {
        set_multicycle_path 2 -setup -from [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_in_r*] -to [get_cells $apb_subsys/u_spi2/u_spi_ctrl/rx_shift_reg_r*] -end
        set_multicycle_path 1 -hold  -from [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_in_r*] -to [get_cells $apb_subsys/u_spi2/u_spi_ctrl/rx_shift_reg_r*] -end
        
	set_false_path -from [get_clocks SPI2_CLK_OUT_DIV] -through [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_in_r_reg*] -to [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_in_d1_r_reg*]
        set_false_path -from [get_clocks SPI2_M_SCLK_DIV] -through [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_in_r_reg*] -to [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_in_d1_r_reg*]

        if {$spi2_slave_support} {
		set_false_path -hold -from [get_clocks SPI2_S_SCLK] -through [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_in_r_reg*] -to [get_cells $apb_subsys/u_spi2/u_spi_ctrl/rx_shift_reg*]
		set_false_path       -from [get_clocks SPI2_S_SCLK] -through [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_in_r_reg*] -to [get_cells $apb_subsys/u_spi2/u_spi_spiif/spi_in_d1_r_reg*]
        }
...
if {$spi1_apbbus_support} {
        if {$spi1_ahbbus_support} {
                set_multicycle_path $pclk_hclk_ratio            -setup -through [get_pins $apb_subsys/u_spi1/u_spi_sync/reg_*_sysclk] -to [get_clocks OSCH] -end
                set_multicycle_path [expr $pclk_hclk_ratio - 1] -hold  -through [get_pins $apb_subsys/u_spi1/u_spi_sync/reg_*_sysclk] -to [get_clocks OSCH] -end
                set_multicycle_path $pclk_hclk_ratio            -setup -through [get_pins $apb_subsys/u_spi1/u_spi_sync/spi_reset_regclk] -to [get_cells $apb_subsys/u_spi1/u_spi_sync/spi_reset_sysclk*] -end
                set_multicycle_path [expr $pclk_hclk_ratio - 1] -hold  -through [get_pins $apb_subsys/u_spi1/u_spi_sync/spi_reset_regclk] -to [get_cells $apb_subsys/u_spi1/u_spi_sync/spi_reset_sysclk*] -end
                set_multicycle_path $pclk_hclk_ratio            -setup -through [get_pins $apb_subsys/u_spi1/pwdata] -to [get_cells $apb_subsys/u_spi1/u_spi_fifo/u_spi_txfifo/mem*] -end
                set_multicycle_path [expr $pclk_hclk_ratio - 1] -hold  -through [get_pins $apb_subsys/u_spi1/pwdata] -to [get_cells $apb_subsys/u_spi1/u_spi_fifo/u_spi_txfifo/mem*] -end
        } elseif {$spi1_eilmbus_support} {
                set_multicycle_path $pclk_coreclk_ratio             -setup -through [get_pins $apb_subsys/u_spi1/u_spi_sync/reg_*_sysclk] -to [get_clocks OSCH] -end
                set_multicycle_path [expr $pclk_coreclk_ratio - 1] -hold  -through [get_pins $apb_subsys/u_spi1/u_spi_sync/reg_*_sysclk] -to [get_clocks OSCH] -end
		set_multicycle_path $pclk_coreclk_ratio             -setup -through [get_pins $apb_subsys/u_spi1/u_spi_sync/spi_reset_regclk] -to [get_cells $apb_subsys/u_spi1/u_spi_sync/spi_reset_sysclk*] -end
                set_multicycle_path [expr $pclk_coreclk_ratio - 1] -hold  -through [get_pins $apb_subsys/u_spi1/u_spi_sync/spi_reset_regclk] -to [get_cells $apb_subsys/u_spi1/u_spi_sync/spi_reset_sysclk*] -end
                set_multicycle_path $pclk_coreclk_ratio             -setup -through [get_pins $apb_subsys/u_spi1/pwdata] -to [get_cells $apb_subsys/u_spi1/u_spi_fifo/u_spi_txfifo/mem*] -end
                set_multicycle_path [expr $pclk_coreclk_ratio - 1] -hold  -through [get_pins $apb_subsys/u_spi1/pwdata] -to [get_cells $apb_subsys/u_spi1/u_spi_fifo/u_spi_txfifo/mem*] -end
        }
}
...
# the multi-cycle setting according to their real run-time usages. When the
# cache size is 0, these constraints can still be applied since those pins
# still exist.
if {$l2c_support} {
	set vc_l2c_top $cpu_subsys/vcmp_core_top/vc_l2c_top
...
# UART
if {$uart1_support} {
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_uart1/paddr]  -through [get_pins $apb_subsys/u_uart1/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_uart1/paddr]  -through [get_pins $apb_subsys/u_uart1/prdata]
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_uart1/psel]   -through [get_pins $apb_subsys/u_uart1/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_uart1/psel]   -through [get_pins $apb_subsys/u_uart1/prdata]
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_uart1/pwrite] -through [get_pins $apb_subsys/u_uart1/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_uart1/pwrite] -through [get_pins $apb_subsys/u_uart1/prdata]
}

if {$uart2_support} {
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_uart2/paddr]  -through [get_pins $apb_subsys/u_uart2/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_uart2/paddr]  -through [get_pins $apb_subsys/u_uart2/prdata]
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_uart2/psel]   -through [get_pins $apb_subsys/u_uart2/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_uart2/psel]   -through [get_pins $apb_subsys/u_uart2/prdata]
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_uart2/pwrite] -through [get_pins $apb_subsys/u_uart2/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_uart2/pwrite] -through [get_pins $apb_subsys/u_uart2/prdata]
}

# PIT
if {$pit_support} {
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_pit/paddr]  -through [get_pins $apb_subsys/u_pit/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_pit/paddr]  -through [get_pins $apb_subsys/u_pit/prdata]
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_pit/psel]   -through [get_pins $apb_subsys/u_pit/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_pit/psel]   -through [get_pins $apb_subsys/u_pit/prdata]
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_pit/pwrite] -through [get_pins $apb_subsys/u_pit/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_pit/pwrite] -through [get_pins $apb_subsys/u_pit/prdata]
}

# GPIO
if {$gpio_support} {
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_gpio/paddr]  -through [get_pins $apb_subsys/u_gpio/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_gpio/paddr]  -through [get_pins $apb_subsys/u_gpio/prdata]
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_gpio/psel]   -through [get_pins $apb_subsys/u_gpio/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_gpio/psel]   -through [get_pins $apb_subsys/u_gpio/prdata]
	set_multicycle_path 2 -setup -through [get_pins $apb_subsys/u_gpio/pwrite] -through [get_pins $apb_subsys/u_gpio/prdata]
	set_multicycle_path 1 -hold  -through [get_pins $apb_subsys/u_gpio/pwrite] -through [get_pins $apb_subsys/u_gpio/prdata]
}

if {$slaveport_support && ($hclk_period != $core_clk_period)} {
	if {$l2c_support} {
		set core_top $cpu_subsys/vcmp_core_top
	}
	else {
		set core_top $cpu_subsys/vc_core_top
	}
	set_multicycle_path [expr $hclk_coreclk_ratio    ] -setup -start -from [get_clocks CORE_CLK] -through [get_pins $core_top/*_slv_h*] -to [get_clocks BUS_CLK]  
	set_multicycle_path [expr $hclk_coreclk_ratio - 1] -hold  -start -from [get_clocks CORE_CLK] -through [get_pins $core_top/*_slv_h*] -to [get_clocks BUS_CLK]  
	set_multicycle_path [expr $hclk_coreclk_ratio    ] -setup -end   -from [get_clocks BUS_CLK ] -through [get_pins $core_top/*_slv_h*] -to [get_clocks CORE_CLK]  
	set_multicycle_path [expr $hclk_coreclk_ratio - 1] -hold  -end   -from [get_clocks BUS_CLK ] -through [get_pins $core_top/*_slv_h*] -to [get_clocks CORE_CLK]  
}
