...
module dual_port_ram (
	...
	input we2,
	input [`AWIDTH-1:0] addr1,
	input [`CU_SIZE*`DWIDTH-1:0] data1,
	output [`CU_SIZE*`DWIDTH-1:0] out1,
	input [`AWIDTH-1:0] addr2,
	input [`CU_SIZE*`DWIDTH-1:0] data2,
	output [`CU_SIZE*`DWIDTH-1:0] out2
);
	reg [`DWIDTH-1:0] ram[((1<<`AWIDTH)-1):0];
	reg [`CU_SIZE*`DWIDTH-1:0] data_out1;
	reg [`CU_SIZE*`DWIDTH-1:0] data_out2;
