...
HD_PWD='/home/users/komal.inayat/Downloads/rc4-prbs/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rc4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rc4.tcl
