...
HD_PWD='/home/users/komal.inayat/Downloads/securehash256bits/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sha256compressionCore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sha256compressionCore.tcl
