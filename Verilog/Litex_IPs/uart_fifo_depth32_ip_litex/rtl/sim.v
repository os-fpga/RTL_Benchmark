...
reg  [5:0] main_uart_tx_fifo_level0 = 6'd0;
reg  main_uart_tx_fifo_replace = 1'd0;
reg  [4:0] main_uart_tx_fifo_produce = 5'd0;
reg  [4:0] main_uart_tx_fifo_consume = 5'd0;
reg  [4:0] main_uart_tx_fifo_wrport_adr = 5'd0;
...
reg  [5:0] main_uart_rx_fifo_level0 = 6'd0;
reg  main_uart_rx_fifo_replace = 1'd0;
reg  [4:0] main_uart_rx_fifo_produce = 5'd0;
reg  [4:0] main_uart_rx_fifo_consume = 5'd0;
reg  [4:0] main_uart_rx_fifo_wrport_adr = 5'd0;
...
always @(*) begin
	main_uart_tx_fifo_wrport_adr <= 5'd0;
...
assign main_uart_tx_fifo_syncfifo_writable = (main_uart_tx_fifo_level0 != 6'd32);
...
always @(*) begin
	main_uart_rx_fifo_wrport_adr <= 5'd0;
...
assign main_uart_rx_fifo_syncfifo_writable = (main_uart_rx_fifo_level0 != 6'd32);
...
always @(posedge sys_clk_1) begin
	...
	if (sys_rst) begin
		...
		main_uart_tx_fifo_readable <= 1'd0;
		main_uart_tx_fifo_level0 <= 6'd0;
		main_uart_tx_fifo_produce <= 5'd0;
		main_uart_tx_fifo_consume <= 5'd0;
		main_uart_rx_fifo_readable <= 1'd0;
		main_uart_rx_fifo_level0 <= 6'd0;
		main_uart_rx_fifo_produce <= 5'd0;
		main_uart_rx_fifo_consume <= 5'd0;
...
//------------------------------------------------------------------------------
// Memory storage: 32-words x 10-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Read-First  | Write-Granularity: 10 
// Port 1 | Read: Sync  | Write: ---- | 
reg [9:0] storage[0:31];
...
//------------------------------------------------------------------------------
// Memory storage_1: 32-words x 10-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: Sync | Mode: Read-First  | Write-Granularity: 10 
// Port 1 | Read: Sync  | Write: ---- | 
reg [9:0] storage_1[0:31];
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-02-03 17:22:29.
//------------------------------------------------------------------------------
