...
HD_PWD='/home/users/komal.inayat/Downloads/md5_pipelined/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Md5Core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Md5Core.tcl
