...
include grlib.load.tcl
read_hdl -vhdl -lib work ../rtl/leon3mp/config.vhd
read_hdl -vhdl -lib work ../rtl/leon3mp/ahbrom.vhd
read_hdl -vhdl -lib work ../rtl/leon3mp/leon3mp.vhd
elaborate leon3mp
