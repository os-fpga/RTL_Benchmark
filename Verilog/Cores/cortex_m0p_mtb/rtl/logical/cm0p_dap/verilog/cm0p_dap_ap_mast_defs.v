...
localparam [31:0] AP_BSE_REG_VAL = 32'hE00FF003;  //ROM Table is at 0xE00FF000
                                     //Format        = 1'b1 (ADI v5)
                                     //Entry Present = 1'b1
localparam [31:0] AP_IDR_REG_VAL = 32'h04770031;  //Revision = 0x0,
                                     //JEP106   = 0x23B
                                     //Class    = 1'b1
                                     //Variant  = 0x3
                                     //Type     = 0x1 (AHB)

// Reset/default slvprot = non-cacheable, non-bufferable, privileged, data
localparam [3:0]  AP_CFGPROT = 4'b0011;
