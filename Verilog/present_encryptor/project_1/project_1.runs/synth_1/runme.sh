...
HD_PWD='/home/users/komal.inayat/Downloads/present_encryptor/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log present_encryptor_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source present_encryptor_top.tcl
