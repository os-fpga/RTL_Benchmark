...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/sap_microprogrammed_processor/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCPU8_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCPU8_1.tcl
