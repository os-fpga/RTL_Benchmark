...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/aor3000/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aoR3000.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aoR3000.tcl
