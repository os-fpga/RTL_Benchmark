...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/ae18/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ae18_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ae18_core.tcl
