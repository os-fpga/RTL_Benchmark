...
// CP0 functions
`define CP0_FUNCTION_TLBR  6'b000001  // TLB Read
`define CP0_FUNCTION_TLBWI 6'b000010  // TLB Write Index
`define CP0_FUNCTION_TLBWR 6'b000110  // TLB Write Random
`define CP0_FUNCTION_TLBP  6'b001000  // TLB Probe
`define CP0_FUNCTION_RFE   6'b010000  // Return From Exception    TODO

// Codes for Exception Cause
`define EXCEPTION_EXTINT       4'b0000  // External Interrupt
`define EXCEPTION_TLBMOD       4'b0001  // TLB Modification
`define EXCEPTION_TLBMISSLOAD  4'b0010  // TLB Miss on Load
`define EXCEPTION_TLBMISSSTORE 4'b0011  // TLB Miss on Store
`define EXCEPTION_ADDRERRLOAD  4'b0100  // Address Error on Load
`define EXCEPTION_ADDRERRSTORE 4'b0101  // Address Error on Store
`define EXCEPTION_IBUSERR      4'b0110  // Instruction Bus Error
`define EXCEPTION_DBUSERR      4'b0111  // Data Bus Error
`define EXCEPTION_SYSCALL      4'b1000  // System Call
`define EXCEPTION_BREAK        4'b1001  // Breakpoint
`define EXCEPTION_RESERVED     4'b1010  // Reserved Opcode
`define EXCEPTION_CPUNUSABLE   4'b1011  // Coprocessor Unusable
`define EXCEPTION_OVERFLOW     4'b1100  // Overflow
