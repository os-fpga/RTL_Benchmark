...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/cpu8080/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu8080.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu8080.tcl
