...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/aemb/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aeMB_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aeMB_core.tcl
