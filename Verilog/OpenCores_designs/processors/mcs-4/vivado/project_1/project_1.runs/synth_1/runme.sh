...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/mcs-4/vivado/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i4004.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i4004.tcl
