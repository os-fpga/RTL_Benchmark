...
HD_PWD='/home/users/komal.inayat/Downloads/sha_core/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sha512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sha512.tcl
