...
HD_PWD='/home/users/komal.inayat/Downloads/nfcc/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kasumi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kasumi.tcl
