...
HD_PWD='/home/users/komal.inayat/Downloads/rsa_512/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rsa_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rsa_top.tcl
