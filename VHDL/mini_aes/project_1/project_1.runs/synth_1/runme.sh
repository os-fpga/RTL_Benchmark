...
HD_PWD='/home/users/komal.inayat/Downloads/mini_aes/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mini_aes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mini_aes.tcl
