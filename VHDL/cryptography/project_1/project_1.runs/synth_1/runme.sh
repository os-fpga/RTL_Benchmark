...
HD_PWD='/home/users/komal.inayat/Downloads/cryptography/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encryptor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source encryptor.tcl
