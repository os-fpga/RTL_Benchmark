...
HD_PWD='/home/users/komal.inayat/Downloads/fully_pipelined_128_aes_algorithm/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AES_Encrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AES_Encrypt.tcl
