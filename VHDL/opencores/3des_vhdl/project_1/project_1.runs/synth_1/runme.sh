...
HD_PWD='/home/users/komal.inayat/Downloads/3des_vhdl/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tdes_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tdes_top.tcl
