...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/avr_core/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AVR_Core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AVR_Core.tcl
