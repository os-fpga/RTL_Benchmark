...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/avr_hp/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AVR_Core_cm4_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AVR_Core_cm4_top.tcl
