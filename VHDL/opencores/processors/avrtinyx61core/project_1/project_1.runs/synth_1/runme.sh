...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/avrtinyx61core/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mcu_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mcu_core.tcl
