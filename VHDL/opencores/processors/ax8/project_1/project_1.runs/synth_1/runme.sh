...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/ax8/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log A90S2313.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source A90S2313.tcl
