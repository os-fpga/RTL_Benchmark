...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/copyblaze/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cp_copyBlaze.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cp_copyBlaze.tcl
