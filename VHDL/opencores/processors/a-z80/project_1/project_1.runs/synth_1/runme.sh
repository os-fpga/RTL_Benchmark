...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/a-z80/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log z80_top_direct_n.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source z80_top_direct_n.tcl
