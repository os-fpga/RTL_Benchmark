...
-- CONFIGURATION SETTING
	...
	constant	 ISTR_LEN 	: integer := 16;
	constant	 STACK_SIZE : integer := 0;
	constant	 MBUS_LEN 	: integer := 12;
	constant	 DIN_LEN 	: integer := 16; -- DIN_LEN >= DATA_LEN
	constant	 DOUT_LEN 	: integer := 16; -- DOUT_LEN >= DATA_LEN
	...
	constant	 ACC_SIZE	: integer := 1;		-- ACC_SIZE >= 1
...
-- SUBTYPE SETTING
	...
	type 	Cpu_abus     is array	((ACC_SIZE - 1) downto 0) of Cpu_acc;
