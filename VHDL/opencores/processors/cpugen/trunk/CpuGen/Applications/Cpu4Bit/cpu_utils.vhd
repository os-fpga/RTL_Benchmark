...
-- CONFIGURATION SETTING
	...
	constant	 IPAGE_LEN 	: integer := 2;
	constant	 DPAGE_LEN 	: integer := 0;
	constant	 DATA_LEN 	: integer := 4;
	constant	 ISTR_LEN 	: integer := 10;
	constant	 STACK_SIZE : integer := 4;
	constant	 MBUS_LEN 	: integer := 4; -- MIN(DATA_LEN,(ISTR_LEN - CODE_LEN))
	constant	 DIN_LEN 	: integer := 4; -- DIN_LEN >= DATA_LEN
	constant	 DOUT_LEN 	: integer := 4; -- DOUT_LEN >= DATA_LEN
...
-- SUBTYPE SETTING
	...
	subtype Cpu_ipage    is std_logic_vector((IPAGE_LEN - 1) downto 0);
