...
-- CONFIGURATION SETTING
	...
	constant	 MBUS_LEN 	: integer := 28; -- MIN(DATA_LEN,(ISTR_LEN - CODE_LEN))
	constant	 DIN_LEN 	: integer := 32; -- DIN_LEN >= DATA_LEN
	constant	 DOUT_LEN 	: integer := 32; -- DOUT_LEN >= DATA_LEN
