...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/atlas_core/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log atlas_2k_base_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source atlas_2k_base_top.tcl
