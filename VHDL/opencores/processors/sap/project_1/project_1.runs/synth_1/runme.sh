...
HD_PWD='/home/users/ayyaz.ahmed/Downloads/sap/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP.tcl
