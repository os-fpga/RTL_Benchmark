...
HD_PWD='/home/users/komal.inayat/Downloads/mod_mult_exp/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ModularMultiplierIterative.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ModularMultiplierIterative.tcl
