...
HD_PWD='/home/users/komal.inayat/Downloads/iota_pow_vhdl/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log de1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source de1.tcl
