...
HD_PWD='/home/users/komal.inayat/Downloads/nfhc/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sha1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sha1.tcl
