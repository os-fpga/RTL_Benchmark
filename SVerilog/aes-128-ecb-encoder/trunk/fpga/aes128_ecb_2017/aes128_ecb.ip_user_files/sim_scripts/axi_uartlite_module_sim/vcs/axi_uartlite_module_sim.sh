...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../aes128_ecb.srcs/sources_1/ip/axi_uartlite_module_sim/sim/axi_uartlite_module_sim.vhd" \
  2>&1 | tee -a vhdlan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_uartlite_module_sim xil_defaultlib.glbl -o axi_uartlite_module_sim_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_uartlite_module_sim_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/v.gulyaev/Project/vozhak/trunk/rtl/aes128/fpga/aes128_ecb/aes128_ecb.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key axi_uartlite_module_sim_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc axi_uartlite_module_sim_simv.daidir)
