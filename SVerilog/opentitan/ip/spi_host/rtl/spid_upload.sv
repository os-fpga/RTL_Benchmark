...
#(
  ...
  prim_sram_arbiter #(
    ...
    .req       (sck_sram_req),
    .req_addr  (sck_sram_addr),
  //  .req_write (sck_sram_write),
  //  .req_wdata (sck_sram_wdata),
    .gnt       (sck_sram_gnt),

    .rsp_rvalid (sck_sram_rvalid), // not used
    .rsp_rdata  (sck_sram_rdata), // not used
    .rsp_error  (sck_sram_rerror),

    .sram_req    (sck_sram_o.req),
    .sram_addr   (sck_sram_o.addr),
    .sram_write  (sck_sram_o.we),
    .sram_wdata  (sck_sram_o.wdata),
    
    .sram_rvalid (sck_sram_i.rvalid),
    .sram_rdata  (sck_sram_i.rdata),
    .sram_rerror (sck_sram_i.rerror)
  );
