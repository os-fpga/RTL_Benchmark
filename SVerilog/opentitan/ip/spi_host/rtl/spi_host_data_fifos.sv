...
module spi_host_data_fifos #(
 ...
 assign tx_depth=1'b0;
  ...
  prim_fifo_sync #(
    ...
    .wready (tx_ready_o),
    .wdata  (tx_data_be),
    .rvalid (core_tx_valid_o),
    .rready (core_tx_ready_i),
    .rdata  (core_tx_data_be)
  );

  logic [RxDepthW-1:0] rx_depth;
 assign rx_depth=1'b0;
  ...
  prim_fifo_sync #(
    ...
    .rst_ni,
    .clr_i    (sw_rst_i),
    .wvalid (core_rx_valid_i),
    .wready (core_rx_ready_o),
    .wdata  (core_rx_data_i),
    .rvalid (rx_valid_o),
    .rready (rx_ready_i),
    .rdata  (rx_data_unordered)
