...
#(
  ...
  prim_fifo_sync #(
    ...
    .rst_ni,
    .clr_i    ( 1'b0               ),
    .wvalid ( otp_rsp_fifo_valid ),
    .wready ( otp_rsp_fifo_ready ),
    .wdata  ( otp_arb_idx        ),
    .rvalid ( otp_fifo_valid     ),
    .rready ( otp_rvalid         ),
    .rdata  ( otp_part_idx       ),
    .depth   (                    )
  );
  ...
  prim_arbiter_tree #(
    ...
    .clk_i,
    .rst_ni,// REQ is allowed to go low again without ACK even
  ...
  // SEC_CM: TOKEN_VALID.CTRL.MUBI
  prim_lc_sender u_prim_lc_sender_test_tokens_valid (
    .clk_i,
    .rst_ni,
  ...
  prim_lc_sender u_prim_lc_sender_rma_token_valid (
    .clk_i,
    .rst_ni,
  ...
  prim_lc_sender  u_prim_lc_sender_secrets_valid (
    .clk_i,
    .rst_ni,
