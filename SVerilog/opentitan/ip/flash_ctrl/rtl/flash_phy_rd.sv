...
(
  ...
  prim_fifo_sync #(
    ...
    .wdata ({alloc_q, descram, forward, data_err, data_int}),
    .depth(unused_rd_depth),
    .rvalid(fifo_data_valid),
    .rready(rd_and_mask_fifo_pop),
    .rdata({alloc_q2, descram_q, forward_q, data_err_q, fifo_data})
  );
