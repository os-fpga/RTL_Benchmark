...
//
  ...
  prim_fifo_sync #(
    ...
    .wvalid       (sfifo_genreq_push),
    .wready       (),
    .wdata        (sfifo_genreq_wdata),
    .rvalid       (sfifo_genreq_not_empty),
    .rready       (sfifo_genreq_pop),
    .rdata        (sfifo_genreq_rdata)
  );
  ...
  assign sfifo_adstage_full=1'b0;
  always_comb begin
    state_d = state_q;
    v_ctr_load = 1'b0;
    v_ctr_inc  = 1'b0;
  ...
  prim_fifo_sync #(
    ...
    .rst_ni         (rst_ni),
    .clr_i          (!ctr_drbg_gen_enable_i),
    .wvalid       (sfifo_adstage_push),
    .wready       (),
    .wdata        (sfifo_adstage_wdata),
    .rvalid       (sfifo_adstage_not_empty),
    .rready       (sfifo_adstage_pop),
    .rdata        (sfifo_adstage_rdata)
  );
  ...
  assign sfifo_rcstage_full=1'b0;
