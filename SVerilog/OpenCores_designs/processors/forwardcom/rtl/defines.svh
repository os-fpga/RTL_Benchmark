...
//`include "config_r32.svh"             // 32 bit registers, 32kB data RAM, 64 kB code RAM, 68 MHz
`include "config_r64.svh"               // 64 bit registers, 32kB data RAM, 64 kB code RAM, 58 MHz
