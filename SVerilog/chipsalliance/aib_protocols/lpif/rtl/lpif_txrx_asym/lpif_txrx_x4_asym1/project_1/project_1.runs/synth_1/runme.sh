...
HD_PWD='/home/users/komal.inayat/Documents/Task_5/aib-protocols/lpif/rtl/lpif_txrx_asym/lpif_txrx_x4_asym1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lpif_txrx_x4_asym1_full_master_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lpif_txrx_x4_asym1_full_master_top.tcl
