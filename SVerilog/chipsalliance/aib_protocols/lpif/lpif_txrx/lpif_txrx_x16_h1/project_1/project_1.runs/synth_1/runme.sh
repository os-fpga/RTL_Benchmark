...
HD_PWD='/home/users/komal.inayat/Desktop/lpif_txrx_x16_h1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lpif_txrx_x16_h1_master_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lpif_txrx_x16_h1_master_top.tcl
