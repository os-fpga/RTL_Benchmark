...
HD_PWD='/home/users/komal.inayat/Documents/Task_5/aib-protocols/axi4-mm/axi_mm_multi/aximm_ll_multi_tier1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log aximm_ll_multi_tier1_master_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source aximm_ll_multi_tier1_master_top.tcl
