...
HD_PWD='/home/users/komal.inayat/Downloads/systemcmd5/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log md5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source md5.tcl
